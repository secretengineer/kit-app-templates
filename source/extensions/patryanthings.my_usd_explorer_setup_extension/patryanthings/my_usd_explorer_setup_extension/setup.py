...
ICON_PATH = carb.tokens.get_tokens_interface().resolve("${patryanthings.my_usd_explorer_setup_extension}/data/icons")
...
class SetupExtension(omni.ext.IExt):
    ...
    def on_startup(self, ext_id: str):
        ...
        self._layouts_path = carb.tokens.get_tokens_interface().resolve("${patryanthings.my_usd_explorer_setup_extension}/layouts")
        ...
        if window_title:
            window_title.set_app_version("0.1.10")
    ...
    def _custom_quicklayout_menu(self):
        ...
        def add_layout_menu_entry(name, parameter, key):
            ...
            layouts_path = carb.tokens.get_tokens_interface().resolve("${patryanthings.my_usd_explorer_setup_extension}/layouts")
